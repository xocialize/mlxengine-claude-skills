...
| 2026-08-30 | SwinIR (0.91M, SwinIR-S ×2) | window attention | **CoreAI-GPU or MLX** — LibreYOLO's `blocked` row does NOT reproduce (exports at 0.70 GB peak RSS) | MEASURED: rank-5 fold took rejections 288→0, but the lane is **still not resident** (1524 MHz, GPU busy), 20× slower than the GPU lane and 6.2× worse on energy. GPU lane is excellent: 71.41 dB, 4.4 ms |
