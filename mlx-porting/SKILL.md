...
- `references/parity-testing.md` — Templates, threshold table, isolation strategy, torch-as-optional-dep, CPU-stream pinning, the exact-match ceiling for cross-backend AR (+ oracle-capture protocol), quantized-generative gating.
